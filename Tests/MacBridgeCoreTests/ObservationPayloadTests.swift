...
final class ObservationPayloadTests: XCTestCase {
  private static let snapshotJSON =
    #"{"capabilities":[],"generatedAtEpochSeconds":1000,"reasoningEfforts":[],"threads":[{"activeTurnID":"turn-1","lastTurnID":"turn-1","lastTurnStatus":"inProgress","projectID":"project-a","status":"active","threadID":"thread-a"},{"projectID":"project-b","status":"idle","threadID":"thread-b"}]}"#
  ...
  func testObservationSchemaDeclaresNoApprovalField() throws {
    ...
    XCTAssertEqual(
      fields, ["generatedAtEpochSeconds", "threads", "capabilities", "reasoningEfforts"])
    XCTAssertFalse(
